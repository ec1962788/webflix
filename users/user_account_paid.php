...
<!DOCTYPE html><html lang="en">
  ...
  <!--Main Body Starts -->
  <body> <?php include('../includes/header_paid.php'); ?> <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped bg-white text-black">
              <tbody>
                ...
                <tr>
                  ...
                  <td> <?php if ($row['user_type_paid'] == 0): ?> <a class="link-danger text-decoration-none" href="../users/register_paid.php">Buy Subscription</a> <?php endif; ?> </td>
                </tr>
                </tr>
              </tbody>
            </table>
