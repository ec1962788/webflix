...
function validate($link, $email = '', $pwd = '')
{
    ...
    if (empty($errors))
    {
        $q = "SELECT user_id, user_name, user_surname, user_type_paid, user_is_admin FROM users WHERE user_email='$e' AND user_pass=SHA2('$p',256)";
        ...
        else { $errors[] = 'Wrong email or wrong password.'; }
    }
