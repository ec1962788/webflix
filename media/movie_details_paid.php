                                                ...
                                                <div class="col-md-3">
                                                    <div class="card mb-4">
                                                        ...
                                                        <div class="card-body text-black">
                                                            ...
                                                            <p class="card-text"><?php echo substr($related_movie['movie_description'], 0, 100) . '...'; ?></p>
                                                            <a href="movie_details_paid.php?movie_id=<?php echo $related_movie['movie_id']; ?>" class="btn btn-danger">View Details</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endwhile; ?>
